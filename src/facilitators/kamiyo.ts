...
export const kamiyoFacilitator = {
  ...
  metadata: {
    name: 'KAMIYO',
    image: 'https://kamiyo.ai/favicon.ico',
    docsUrl: 'https://kamiyo.ai/api-docs',
    color: '#00D4AA',
    ogImage: 'https://kamiyo.ai/media/KAMIYO_OpenGraphImage.png',
    ogTitle: 'KAMIYO x402 Facilitator',
    ogDescription: 'Cross-chain oracle data verification and settlement via KAMIYO',
  },
  config: kamiyo,
